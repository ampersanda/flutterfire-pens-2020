                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color:
                                    isMe ? Colors.lightBlue : Colors.blueGrey,
            ...
            Row(
              children: [
                ...
                FlatButton.icon(
                  ...
                  label: Text('Send', style: TextStyle(color: Colors.blue)),
                ),
              ],
            ),
          ],
            ...
            actions: [
              FlatButton(
                onPressed: () {
                  ...
                  final String to = user.uid == 'X4ElNF2sxPR4Cl1zlvx23LlLiCO2'
                      ? 'hp9lC9EJROSlkUEfvnDNsN7aIA72'
                      : 'X4ElNF2sxPR4Cl1zlvx23LlLiCO2';
